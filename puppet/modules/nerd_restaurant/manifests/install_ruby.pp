class nerd_restaurant::install_ruby {

  # nerd_restaurant::install_nginx depends on this ruby/version combination
  $ruby_type = "ruby"
  $ruby_version = "2.1.2"
  ...
  file { '/etc/profile.d/chruby.sh':
    ...
    source => '/vagrant/puppet/modules/nerd_restaurant/files/chruby.sh',
