...
Welcome to the nerd_restaurant vagrant VM.
...
1. The application lives in ~/nerd_restaurant. Go there: $ cd nerd_restaurant
...
to install the nerd_restaurant app natively on your guest vm.
